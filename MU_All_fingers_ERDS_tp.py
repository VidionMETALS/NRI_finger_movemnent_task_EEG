...
Thumb_epochs = mu_epochs[Thumb_idx] # selects only Thumb trials
...
# 1. Plot the continuous average Mu ERDS curve line
...
plt.title('MU ERDS (Phase Structured) - Right Thumb', fontsize=13, fontweight='bold', pad=15)
...
Index_epochs = mu_epochs[Index_idx] # selects only Index trials
...
plt.xlabel('Time (s)', fontsize=11, fontweight='bold')
plt.ylabel('ERD / ERS', fontsize=11, fontweight='bold')
plt.title('MU ERDS (Phase Structured) - Right Index', fontsize=13, fontweight='bold', pad=15)
...
Middle_epochs = mu_epochs[Middle_idx] # selects only Middle trials
...
plt.xlabel('Time (s)', fontsize=11, fontweight='bold')
plt.ylabel('ERD / ERS', fontsize=11, fontweight='bold')
plt.title('MU ERDS (Phase Structured) - Right Middle', fontsize=13, fontweight='bold', pad=15)
...
Ring_epochs = mu_epochs[Ring_idx] # selects only Ring trials
...
plt.xlabel('Time (s)', fontsize=11, fontweight='bold')
plt.ylabel('ERD / ERS', fontsize=11, fontweight='bold')
plt.title('MU ERDS (Phase Structured) - Right Ring', fontsize=13, fontweight='bold', pad=15)
...
Little_epochs = mu_epochs[Little_idx] # selects only Little trials
...
plt.xlabel('Time (s)', fontsize=11, fontweight='bold')
plt.ylabel('ERD / ERS', fontsize=11, fontweight='bold')
plt.title('MU ERDS (Phase Structured) - Right Little', fontsize=13, fontweight='bold', pad=15)
